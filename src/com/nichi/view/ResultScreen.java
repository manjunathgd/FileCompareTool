...
//		if (FileOperations.encodingType.equals("MS932") || FileOperations.encodingType.contains("JIS") || FileOperations.encodingType.contains("Cp125")) {
//			myWriter = new OutputStreamWriter(fileOutputStream, "Shift_JIS");
//		} else if (FileOperations.encodingType.contains("EUC")) {
//			myWriter = new OutputStreamWriter(fileOutputStream, "EUC-JP");
//		} else {
//			myWriter = new OutputStreamWriter(fileOutputStream, "UTF-8");
//		}
		myWriter = new OutputStreamWriter(fileOutputStream, "UTF-8");
